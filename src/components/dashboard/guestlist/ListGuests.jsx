              ...
              <tr key={guest.guest_id} className="hover:bg-gray-50">
                  ...
                  >
                    <span
                      className={`h-1.5 w-1.5 rounded-full ${
                        guest.std_sent === true ? "bg-green-600" : "bg-red-600"
                      }`}
                    ></span>
                    {guest.std_sent === true ? "Yes" : "No"}
                  </span>
                </td>
                <td className="px-6 py-4">
                  <span
                ...
                <td className="px-6 py-4">
                  ...
                  >
                    ...
                    ></span>
                    {guest.rsvp_status === true ? "Yes" : "No"}
                  </span>
                </td>
                <td className="px-6 py-4">{guest.user_email}</td>
                <td className="px-6 py-4">
